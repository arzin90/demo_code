...
return [
    ...
    */
    ...
    'after'                => 'В поле :attribute должно быть введено большее число, чем в поле :date.',
    ...
    'date_format'          => 'Поле :attribute не соответствует формату ГГГГ-ММ-ДД.',
    ...
    'phone'                => 'В поле :attribute указан неверный номер.',
    ...
    */
    ...
    'attributes' => [
        ...
        'graduation_at'         => 'Год окончания',
        'passport'              => 'Фото с паспортом',
        'diploma'               => 'Документы',
        'online'                => 'Онлайн запись',
        'offline'               => 'Офлайн запись',
        'popular'               => 'Популярный',
        'video'                 => 'Видео',
        'key'                   => 'Ключ',
        'location_id'           => 'Местонахождение',
        'b_day'                 => 'Дата рождения',
        'avatar'                => 'Фото',
        'members'               => 'Учасники',
        'members.*'             => 'Учасника',
        ...
        'gallery'               => 'Галерея',
        'chapter_ids'           => 'Формат программы',
        'chapter_ids.*'         => 'Формат программы',
        'dates'                 => 'Дата',
        'dates.*.times'         => 'Время',
        'dates.*.date'          => 'Дата',
        'dates.*.times.*.start_time' => 'Начальное время',
        'dates.*.times.*.end_time'   => 'Время окончания',
        'pseudonym'             => 'Псевдоним',
