...
namespace Illuminate\Support\Facades {
    ...
    class Redis
    {
         ...
         *
         * @param string       $key
         * @param mixed|string $value String, value to push in key
         *
         * @return bool|int the new length of the list in case of success, FALSE in case of Failure
         *
         ...
         *
         * @param array<string>|string $keys    String array containing the keys of the lists OR variadic list of strings
        ...
        /**
         * @see lRem
         * @see https://redis.io/commands/lremove
         ...
         * @param mixed|string ...$value1 Variadic list of values
         *
         ...
         *
         * @param string       $key
         * @param mixed|string ...$member1 Variadic list of members
         *
         ...
         * @param mixed|string $value
         *
         * @return mixed|string A string (mixed, if used serializer), the previous value located at this key
         *
         ...
         * @param string $key
         *
         * @return bool|int|string for "encoding", int for "refcount" and "idletime", FALSE if the key doesn't exist
         *
         ...
         * @param string $key
         *
         * @return bool|int the time left to live in seconds
         *
         ...
         * @param string $key
         *
         * @return bool|int the time left to live in milliseconds
         *
         ...
         * @param string       $key
         * @param mixed|string $member1
         * @param mixed|string ...$otherMembers
         *
         ...
         *
         * @see    https://redis.io/commands/zsize
         *
         * @example
         * <pre>
         * $redis->zAdd('key', 0, 'val0');
         ...
         * @param mixed|string $member
         *
         * @return bool|float false if member or key not exists
         *
         ...
         * @param mixed|string $member
         *
         * @return bool|int the item's score, or false if key or member is not exists
         *
         ...
         * @param mixed|string $member
         *
         * @return bool|int the item's score, false - if key or member is not exists
         *
         ...
         *
         * @param array|string $key1
         * @param array|string $key2    ...
         * @param int          $timeout
         *
         ...
         * @param mixed|string $value     optional string (only for `SET`)
         *
         ...
         * @param string $key
         *
         * @return bool|string The Redis encoded value of the key, or FALSE if the key doesn't exist
         *
         ...
         *
         * @see    https://redis.io/commands/sadd
         * @see    https://github.com/phpredis/phpredis/commit/3491b188e0022f75b938738f7542603c7aae9077
    ...
    class RedisArray
    {
         ...
         * Constructor.
         *
         * @param array|string $hosts Name of the redis array from redis.ini or array of hosts to construct the array with
